    ...
    public function seedPermissionsAndRoles(?int $actorId = null): array
    {
        return DB::transaction(function () use ($actorId): array {
            ...
            $permissions = [
                ...
                ['PermissionCode' => 'ticket.view', 'PermissionName' => 'Xem phiếu', 'Module' => 'Ticket'],
                ['PermissionCode' => 'ticket.create', 'PermissionName' => 'Tạo phiếu', 'Module' => 'Ticket'],
                ['PermissionCode' => 'ticket.approve', 'PermissionName' => 'Duyệt phiếu', 'Module' => 'Ticket'],
                ['PermissionCode' => 'ticket.delete', 'PermissionName' => 'Xóa phiếu', 'Module' => 'Ticket'],
                ...
                ['PermissionCode' => 'transaction.view', 'PermissionName' => 'Xem giao dịch', 'Module' => 'Transaction'],
                ['PermissionCode' => 'transaction.create', 'PermissionName' => 'Tạo giao dịch', 'Module' => 'Transaction'],
